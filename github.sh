...
export name='mariaeduardamassotte'
export email="maria.massotte@etec.sp.gov.br"
export repositorio="https://github.com/mariaeduardamassotte/bd3_mysql_3h3-1.git";

#Daqui pra baixo mexa somente se for realmente necessário ou se souber o que está fazendo :P

export branch_name="bd3-$(date +%Y%m%d)"
